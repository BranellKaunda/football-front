...
<template>
  <h1 class="m-8 text-2xl font-bold text-center">Create Player</h1>
  <form
    @submit.prevent="save"
  ...
  >
    ...
    <div class="flex flex-col gap-2">
      ...
      <input v-model="draft.firstName" />
    </div>

    <div class="flex flex-col gap-2">
      <label>Last name</label>
      <input v-model="draft.lastName" />
    </div>
    ...
    <div class="flex flex-col gap-2">
      ...
      <input v-model.number="draft.weightKg" />
    </div>

    <div class="flex flex-col gap-2">
      <label>Height (cm)</label>
      <input v-model.number="draft.heightCm" />
    </div>
